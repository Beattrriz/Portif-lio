...
export default function Contact() {
    return (
        <section
            id="contato"
            className="py-5 bg-gradient-to-bl from-black via-pink-500 to-black text-center"
        >
            <div className="flex flex-col items-center">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-xs text-white mt-1">LinkedIn</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-xs text-white mt-1">GitHub</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-xs text-white mt-1">E-mail</p>
                    </div>
